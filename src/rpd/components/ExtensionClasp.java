 ...
 */
public class ExtensionClasp extends Clasp {
	private ClaspArm buccal_arm = null;
	private ClaspArm lingual_arm = null;
	private OcclusalRest occlusal_rest = null;

	public ExtensionClasp(Tooth tooth_pos, Position tip_direction, ClaspMaterial buccal_material,
	...
	public ExtensionClasp(Tooth tooth_pos, Position tip_direction, ClaspMaterial material) {
	...
	public ExtensionClasp(Tooth tooth_pos, Position tip_direction) {
